...
Version  : 5
Release  : 1
URL      : https://github.com/clearlinux/clr-man-pages/releases/download/v5/clr-man-pages-5.tar.xz
Source0  : https://github.com/clearlinux/clr-man-pages/releases/download/v5/clr-man-pages-5.tar.xz
...
%prep
%setup -q -n clr-man-pages-5

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485210533
